                        ...
                        <div class="card-body tabel-mahasiswa cell-border">
                            ...
                            <table id="tabel" class="cell-border table-sm dataTable" cellspacing="1" width="100%"
                                ...
                                <tbody class="table-bordered table-hover"
                                    ...
                                    <?php
                                    $query = "SELECT * FROM `sertif` ORDER BY ID";
                                    ...
                                    <td id='display-image' style='outline: 1px solid #CCC; overflow:auto;'><img src='../assets/imageinput/" . $row->Filee . "' style='width:100px; height:70px;'></td>
