...
if (isset($_SESSION['username'])):
    ...
    $queryins = mysqli_query($conn, "INSERT INTO sertif_del (ID, IdUser, Nama, Email, NamaSertif, SertifID, IssuedBy, Kategori, DeletedAt, DeletedBy) VALUES('$id', '$rowuser->IdUser', '$rowuser->Nama', '$rowuser->Email', '$rowsertif->NamaSertif', '$rowsertif->SertifID', '$rowsertif->IssuedBy', '$rowsertif->Kategori', NOW(), '$rowuser->username')");

    if ($queryins) {
        $querys = "DELETE FROM sertif WHERE ID='$id'";
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4" style="font-size: 14px">
                            ...
                            <li class="breadcrumb-item active">Delete Certificate</li>
                        </ol>
                    ...
                    <div class="container-fluid" style="width: 70%; margin-top: 3%; margin-bottom: 3%">
                        <h3 class="my-3" style="color: #2e2d2d">Delete Certificate</h3>
                        <div class="row">
                            <div class="col">
                                <div class="card mb-4">
                                    <div class="card-header" style="background-color: #2e2d2d;">
                                        ...
                                        <b style="color: white;">Delete Certificate</b>
                                    </div>
                                    <div class="card-body">
                                        <div class="container overflow-hidden">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <a type="submit" class="btn btn-primary" href="../index-employee.php"
        ...
        <body onload="zoom_auto()" class="sb-nav-fixed">
            <div id="layoutSidenav_content" style="background-color: #fafafa">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" style="color: rgb(37, 150, 190)"><b>E-Certification<b
                                    style="float: right; color: #D1B000">Employee <i class="bi bi-patch-check-fill"
                                        style="color: #0096FF"></i></b></b></h1>
                        <ol class="breadcrumb mb-4" style="font-size: 14px">
                            <li class="breadcrumb-item"><a href="../index-employee.php" style="color: #33abf6"><i
                                        class="fa fa-home"></i></a></li>
                            <li class="breadcrumb-item active">Delete Certificate</li>
