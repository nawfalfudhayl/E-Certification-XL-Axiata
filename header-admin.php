            ...
            <div id="layoutSidenav_nav"
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: white;">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../lihat-admin/lihat-sertif-admin.php"
                    ...
                    <div class="sb-sidenav-footer" style="background-color: #164396;">
                        ...
                        echo "<div style='font-size: 14px; color: white'>" . $_SESSION['username'] . "<br>" . $row_user['Akses'] . "<br><a style='color: white; font-size: 12px;'>ID : <b id='space'>" . $row_user['ID'] . "</b></a></div>";
                        ?>
                    </div>
                </nav>
            </div>
