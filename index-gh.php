...
if (isset($_SESSION['username'])):
    ...
    <body class="sb-nav-fixed" onload="zoom_auto()" style="font-family: Axiata;">
        <nav class="sb-topnav navbar navbar-expand"
            ...
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index-gh.php"
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: white;">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index-gh.php" style="color: #2e2d2d">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="lihat-gh/lihat-sertif-gh.php" style="color: #2e2d2d"><i
                                            class="bi bi-journals"
                                            style="margin-right: 10px; font-size: 16px; color: #2e2d2d"></i>Certificate</a>
                                    <a class="nav-link" href="lihat-gh/lihat-ktgr-gh.php" style="color: #2e2d2d"><i
                                            class="bi bi-list-check"
                                            style="margin-right: 10px; font-size: 16px; color: #2e2d2d"></i>Category</a>
                                    <a class="nav-link" href="lihat-gh/lihat-approval-gh.php" style="color: #2e2d2d"><i
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                                data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="lihat-gh/lihat-user-gh.php" style="color: #2e2d2d"><i
