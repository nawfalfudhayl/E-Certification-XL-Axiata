...
if (isset($_SESSION['username'])):
    ...
    <body class="sb-nav-fixed" onload="zoom_auto()" style="font-family: Axiata;">
        <nav class="sb-topnav navbar navbar-expand"
            ...
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index-chief.php"
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: white;">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index-chief.php" style="color: #2e2d2d">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="lihat-chief/lihat-sertif-chief.php" style="color: #2e2d2d"><i
                                            class="bi bi-journals"
                                            style="margin-right: 10px; font-size: 16px; color: #2e2d2d"></i>Certificate</a>
                                    <a class="nav-link" href="lihat-chief/lihat-ktgr-chief.php" style="color: #2e2d2d"><i
                                            class="bi bi-list-check"
                                            style="margin-right: 10px; font-size: 16px; color: #2e2d2d"></i>Category</a>
                                    <a class="nav-link" href="lihat-chief/lihat-approval-chief.php" style="color: #2e2d2d"><i
                                            class="fa fa-check-circle"
                                            style="margin-right: 10px; font-size: 16px; color: #2e2d2d"></i>Certificates
                                        Approval</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                                data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="lihat-chief/lihat-user-chief.php" style="color: #2e2d2d"><i
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header" style="background-color: #164396; color: white; font-size: 15px">
                                ...
                                <b>Amount of</b> <b style="color: palegreen">User</b>
                            </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-header" style="background-color: #164396; color: white; font-size: 15px">
                                <i class="fas fa-chart-bar me-1"></i>
                                <b>Amount of Certificates based on</b> <b style="color: palegreen">Category</b>
                            </div>
