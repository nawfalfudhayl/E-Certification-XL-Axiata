...
if (isset($_SESSION['username'])):
    ...
    $querys = "UPDATE sertif SET `ApprovalStatus`='Approved', `ApprovedAt`=NOW(), `ApprovedBy`='Mochamad Hira Kurnia' WHERE `ApprovalStatus` IN ('', 'Not Approved')";
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4" style="font-size: 14px">
                            ...
                            <li class="breadcrumb-item"><a href="../lihat-chief/lihat-approval-chief.php" style="color: #33abf6">Certificates
                                    Approval</a></li>
                                        ...
                                        <div class="container overflow-hidden">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <b>Certification Data Successfully Update!</b>
                                                </div>
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <img src='../assets/images/check-removed.gif'>
                                                </div>
                                                <a type="submit" class="btn btn-primary"
                                                    href="../lihat-chief/lihat-approval-chief.php" style="float: left;"><b>OK</b></a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="container overflow-hidden">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <a type="submit" class="btn btn-primary"
                                                    href="../lihat-chief/lihat-approval-chief.php"
