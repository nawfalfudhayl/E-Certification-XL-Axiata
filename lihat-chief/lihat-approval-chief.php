            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4" style="font-size: 14px">
                        <li class="breadcrumb-item"><a href="../index-chief.php" style="color: #33abf6"><i
                                    class="fa fa-home"></i></a></li>
                        <li class="breadcrumb-item active">Certificates Approval</li>
                    </ol>
                    ...
                    <div class="card mb-4" style="border: 0,5px solid #2e2d2d">
                        ...
                        <div class="card-body tabel-mahasiswa cell-border">
                            <center>
                                <b style="color: #2e2d2d; font-size: 28px">Certification Approval Data</b>
                            </center>
                            <a type="submit" class="btn btn-success" href="../edit-chief/bulk-approve-chief.php"
                                title='Approve All Certificates' onclick='return checkApprove()'><b>Approve All</b></a>
                            ...
                            <table id="tabel" class="cell-border table-sm dataTable" cellspacing="1" width="100%"
                                ...
                                <tbody class="table-bordered table-hover"
                                    ...
                                    <?php
                                    $query = "SELECT * FROM `sertif`  WHERE ApprovalStatus IN ('','Not Approved') ORDER BY SertifID";
                                    ...
                                    <td>
                                        <form action='../edit-chief/approve-sertif-chief.php?ID=" . $row->ID . "' method='POST'>
                                            <input type='submit' class='btn btn-success' name='submit' value='Approve' onclick='return checkApprove()' title='Approve this certificate'>
                                        </form>
                                    </td>
                                    </tr>";
                                        $i++;
                            ...
                            <br>
                            <a type="submit" class="btn btn-danger" href="../index-chief.php"><b><i
                                        class="fas fa-arrow-circle-left"></i> Home</b></a>
                        </div>
                    </div>
                    <script language="JavaScript" type="text/javascript">
                        function checkApprove() {
                            return confirm('Are you sure to approve this certificate?');
                        }
                    </script>
                    <script>
                        $(document).ready(function () {
                            ...
                            $('#tabel2').DataTable({
                                ...
                                "language": {
                                    ...
                                    "lengthMenu": "<a style='font-size: 14px;'><i class='bi bi-caret-right-fill' style='color: rgb(37, 150, 190)'></i> &nbsp;<b>Show _MENU_ Data</b></a>",
                                    "search": "<i class='bi bi-caret-right-fill' style='color: rgb(37, 150, 190)'></i> &nbsp;<a style='font-size: 18px;'><b><i class='fas fa-search'></i></b> </a>"
                                },
                                "columnDefs": [
                                    { "orderable": false, "targets": [1, 2, 3, 4] },
