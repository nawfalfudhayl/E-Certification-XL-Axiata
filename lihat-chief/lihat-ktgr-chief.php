                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4" style="border: 0,5px solid #2e2d2d">
                        ...
                        <div class="card-body tabel-mahasiswa cell-border">
                            ...
                            <!-- <a type="submit" class="btn btn-success" href="../input-chief/tamb-jnsd-chief.php"
                            ...
                            <br><br>
                            <table id="tabel1" class="cell-border table-sm dataTable" cellspacing="1" width="100%"
                                style="border: 0px solid; font-size: 14px; table-layout: fixed;">
