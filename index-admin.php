                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="lihat-admin/lihat-sertif-admin.php" style="color: #2e2d2d"><i
                                            class="bi bi-journals"
                                            style="margin-right: 10px; font-size: 16px; color: #2e2d2d"></i>Certificate</a>
                                    <a class="nav-link" href="lihat-admin/lihat-ktgr-admin.php" style="color: #2e2d2d"><i
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                                data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="lihat-admin/lihat-user-admin.php" style="color: #2e2d2d"><i
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header" style="background-color: #164396; color: white; font-size: 15px">
                                ...
                                Amount of <b style="color: palegreen">User</b>
                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-footer small text-muted" style="background-color: #ececec">Last Update : <b>Today</b></div>
                        </div>
                    </div>
                </main>
