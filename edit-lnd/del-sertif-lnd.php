...
if (isset($_SESSION['username'])):
    ...
    $queryins = mysqli_query($conn, "INSERT INTO sertif_del (ID, IdUser, Nama, Email, NamaSertif, SertifID, IssuedBy, Kategori, DeletedAt, DeletedBy) VALUES('$id', '$rowsertif->IdUser', '$rowsertif->Nama', '$rowsertif->Email', '$rowsertif->NamaSertif', '$rowsertif->SertifID', '$rowsertif->IssuedBy', '$rowsertif->Kategori', NOW(), '$rowuser->username')");
                                        ...
                                        <div class="container overflow-hidden">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <a type="submit" class="btn btn-primary"
                                                    href="../lihat-lnd/lihat-sertif-lnd.php" style="float: left;"><b>OK</b></a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
