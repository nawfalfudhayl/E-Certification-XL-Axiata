...
if (isset($_SESSION['username'])):
    ...
    $querys = "UPDATE sertif SET `ApprovalStatus`='Approved', `ApprovedAt`=NOW(), `ApprovedBy`='$rowuser->Nama' WHERE ID='$id'";
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4" style="font-size: 14px">
                            ...
                            <li class="breadcrumb-item"><a href="../lihat-approval-lnd.php" style="color: #33abf6">Certificates
                                    Approval</a></li>
