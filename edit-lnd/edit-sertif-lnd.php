...
if (isset($_SESSION['username'])):
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($filename == '' and $tglterbit == '' and $tglexp == '' and $ktgr1 == '-- Pilih Kategori --' and $judul == '' and $pengarang == '' and $sinopsis == '') {
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4" style="border: 0,5px solid #2e2d2d">
                        <div class="card-body tabel-mahasiswa cell-border">
                            <center>
                                <b style="color: #2e2d2d; font-size: 28px">Edit Certificate</b>
                            </center>
                                        ...
                                        <form method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <a style="color: black; font-size: 11px;">*Format .jpg,
                                                    .jpeg, atau .png!<br>*Ukuran gambar harus <label style="color: red">500x380
                                                        pixel</label> (px)!<br>*Belum
                                                    mengubah ukuran gambar? </a><a href="https://imageresizer.com/"
                                                    target="_blank" style="font-size: 14px;">Klik</a>
                                            </div>
                                            <center style="margin-top: 3%; background-color: #5a5a5a; border-radius: 50px;">
                                                <hr size="3px" color="black"
                                                    style="background-color: black; border-radius: 50px;" />
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputsinopsis"><b>Description</b><b style="color: red"></b></label>
                                                <div class="col-sm-14">
                                            ...
                                            <a type="submit" class="btn btn-danger"
                                                href="../lihat-lnd/lihat-sertif-lnd.php"><b><i
